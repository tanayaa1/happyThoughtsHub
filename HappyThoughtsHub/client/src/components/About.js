		...
		<div className="about">
			...
			<main>
				<section id="hero" className="hero">
					...
					<p className="speech1">
						<h6>
							Mental health is not a sign of weakness; it is a testament to the
							strength of the human spirit. Just as we care for our physical
							well-being, we must prioritize and nurture our mental well-being
							too. Seeking help and support for mental health challenges is an
							act of courage, resilience, and self-empowerment. Let us break the
							stigma and embrace the truth: mental health is a vital part of our
							overall health, and caring for it is a mark of true strength and
							wisdom. Together, by fostering empathy, understanding, and
							compassion, we can build a world where everyone feels safe to
							share their struggles and find healing, hope, and happiness on
							their journey to well-being. Remember, you are not alone, and
							seeking help is not a sign of weakness—it is a courageous step
							towards inner strength and a brighter future.
						</h6>
					</p>
					<input
						type="text"
